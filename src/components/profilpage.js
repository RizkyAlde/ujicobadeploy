...
function ProfilePage() {
  ...
  return (
    <div
      ...
      style={{ height: "100vh", overflow: "hidden" }} // Set height to 100vh and hide overflow
    >
      <div className="flex gap-5 h-full max-md:flex-col">
        <div
          className="flex flex-col w-full h-full max-md:w-full"
          style={{
            backgroundImage: 'url("/Image/bg_melon.png")', // Update background image path
          ...
          <div className="flex z-10 flex-col items-left mt-10 font-bold text-center h-full max-md:mt-5 max-md:max-w-full">
            <div className="flex items-center justify-center">
              <Image
                ...
                src="/Image/logo.png" // Update the src path
                alt="Replon Logo"
                className="max-w-full aspect-[0.93] w-[100px]" // Adjust image size
              />
              ...
              <Image
                ...
                onClick={handleHome} // Add onClick handler
                style={{ cursor: "pointer", height: 30 }} // Add cursor pointer
              />
            </div>
            <div
        ...
        <div className="flex flex-col w-full h-full max-md:w-full">
          ...
          >
            <div className="flex justify-center items-center mt-8">
              <Image
                src="/Image/logo.png" // Update with your profile image path
                alt="Profile Picture"
                className="w-[100px] h-[100px] rounded-full object-cover" // CSS for profile image
              />
            </div>
