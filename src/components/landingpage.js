...
function LandingPage() { // Ubah dari `landingpage` menjadi `LandingPage`
        ...
        <div className="flex flex-col w-6/12 h-full max-md:w-full">
          <div className="flex z-10 flex-col items-center mt-10 font-bold text-center h-full max-md:mt-5 max-md:max-w-full">
            <Image
              ...
              alt="Dashboard Replon Icon"
              width={150} // Set width secara eksplisit
              height={139.5} // Set height sesuai aspect ratio 0.93
        ...
        <div className="flex flex-col ml-5 w-6/12 h-full max-md:w-full">
          <div className="flex relative flex-col grow pt-12 pr-8 pb-2.5 text-center h-full max-md:max-w-full">
            <Image
              ...
              layout="fill" // Gunakan layout fill agar gambar memenuhi kontainer
              objectFit="cover"
            />
            <div
...
export default LandingPage; // Ubah nama komponen pada ekspor juga
