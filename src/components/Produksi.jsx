  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#ECEAE2]">
      ...
      <div className="flex ml-2 mb-4">
        <div className="flex-2 rounded-2xl shadow flex justify-between md:px-2 md:py-2 mt-2 mx-2 bg-white">
          <select
            className="border border-green-200 rounded-xl p-2 pl-2 cursor-pointer focus:outline-none font-bold focus:border-green-200"
            style={{ backgroundColor: "#AED260", color: "black", paddingRight: "0.5px" }}
          >
            <option style={{ backgroundColor: "#AED260", color: "black" }}>Green House 1</option>
            <option style={{ backgroundColor: "#AED260", color: "black" }}>Green House 2</option>
            <option style={{ backgroundColor: "#AED260", color: "black" }}>Green House 3</option>
            <option style={{ backgroundColor: "#AED260", color: "black" }}>Green House 4</option>
            <option style={{ backgroundColor: "#AED260", color: "black" }}>Green House 5</option>
            <option style={{ backgroundColor: "#AED260", color: "black" }}>Green House 6</option>
            <option style={{ backgroundColor: "#AED260", color: "black" }}>Green House 7</option>
            <option style={{ backgroundColor: "#AED260", color: "black" }}>Green House 8</option>
            <option style={{ backgroundColor: "#AED260", color: "black" }}>Green House 9</option>
            <option style={{ backgroundColor: "#AED260", color: "black" }}>Green House 10</option>
            <option style={{ backgroundColor: "#AED260", color: "black" }}>Green House 11</option>
            <option style={{ backgroundColor: "#AED260", color: "black" }}>Green House 12</option>
          </select>
        </div>
      </div>
      <div className="flex flex-col gap-3 md:flex-row md:gap-2">
        <div className="px-6 py-4 bg-white w-[63%] rounded-lg shadow-[0px_8px_24px_rgba(69,69,80,0.1)] md:px-3 md:py-3 mr-2 mt-1 mb-5 mx-4 mb-2">
          <div className="flex flex-col h-[100%] px-8 py-4 bg-lime-300 rounded-lg shadow-lg max-md:max-h-full max-md:max-w-full">
            ...
            <Image
              loading="lazy"
              src="https://cdn.builder.io/api/v1/image/assets/TEMP/3e8c3000b412ab0f2b352b838ffa02d70ec58b5bf2a8f3953014a23b4b5e64b6?apiKey=56720a43f79840e1abfb6fc8af490491"
              alt="Prediksi Jumlah Produksi"
        ...
        <div className="px-6 py-4 bg-white w-[37%] rounded-lg shadow-[0px_8px_24px_rgba(69,69,80,0.1)] md:px-3 md:py-3 ml-2 mt-1 mb-5 mx-4 mb-2">
          <div className="flex flex-col h-full aspect-w-5 aspect-h-3 px-2 py-4 bg-lime-300 rounded-lg shadow-lg max-md:max-h-full max-md:max-w-full">
            ...
            <Image
              loading="lazy"
              src="https://cdn.builder.io/api/v1/image/assets/TEMP/01351868f4dcf0df931bb34ad729e6e938a55dba41d54f95b98f7a87b9dd1671?apiKey=56720a43f79840e1abfb6fc8af490491"
              alt="Prediksi Jumlah Produksi"
